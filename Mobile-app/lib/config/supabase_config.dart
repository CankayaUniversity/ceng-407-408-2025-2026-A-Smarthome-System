...
class SupabaseConfig {
  ...
  // Live camera stream — WebSocket relay URL only (web parity).
  // Pass via `--dart-define=RELAY_WS_URL=ws://...`. Consumed by
  // `lib/camera_screen.dart` directly; tracked here for the Settings info row.
